...
{ 
  void QeoxuDzVPl()
  { 
      bool RkgmxmVrXz = false;
      bool DmuuVRThDh = false;
      bool OceVHIkTWp = false;
      bool JVujVyhpuE = false;
      bool aZxnmiNdBK = false;
      bool KiCuyoFLeo = false;
      bool BBUhogrLYX = false;
      bool iclyGneqiX = false;
      bool uHSLeZTzlf = false;
      bool rWLGDYFPyF = false;
      bool qBEdahxDoJ = false;
      bool KOcHssiJCO = false;
      bool NrYreMQeug = false;
      bool iOrcfsDojw = false;
      bool cQKbVdsDMJ = false;
      bool puNirybLyO = false;
      bool QRHHZuVzaA = false;
      bool psYFlwhxWA = false;
      bool SNRlqnBJkg = false;
      bool QqpVeKJDBa = false;
      string PglzzKleez;
      string xgVMkzRsjl;
      string TPMxqICVnX;
      string jCWljAZiUq;
      ...
      string iPdsqxRVmp;
      string WIYWceQFdM;
      if(PglzzKleez == Fuknsoqiiq){RkgmxmVrXz = true;}
      else if(Fuknsoqiiq == PglzzKleez){qBEdahxDoJ = true;}
      if(xgVMkzRsjl == pOggMTSUIw){DmuuVRThDh = true;}
      else if(pOggMTSUIw == xgVMkzRsjl){KOcHssiJCO = true;}
      if(TPMxqICVnX == TairFmItIn){OceVHIkTWp = true;}
      else if(TairFmItIn == TPMxqICVnX){NrYreMQeug = true;}
      if(jCWljAZiUq == LJPNUiCIcJ){JVujVyhpuE = true;}
      else if(LJPNUiCIcJ == jCWljAZiUq){iOrcfsDojw = true;}
      if(gZHGoPeNZR == brzJtQDsQO){aZxnmiNdBK = true;}
      else if(brzJtQDsQO == gZHGoPeNZR){cQKbVdsDMJ = true;}
      if(YPankzUoIq == xNqsaeLsiF){KiCuyoFLeo = true;}
      else if(xNqsaeLsiF == YPankzUoIq){puNirybLyO = true;}
      if(IPqHPuJjck == gxatfgzSLd){BBUhogrLYX = true;}
      else if(gxatfgzSLd == IPqHPuJjck){QRHHZuVzaA = true;}
      if(YiYrFtIFIa == RKqzUaaYxn){iclyGneqiX = true;}
      if(dnwVzTaiAk == iPdsqxRVmp){uHSLeZTzlf = true;}
      if(fkZdiQhzpt == WIYWceQFdM){rWLGDYFPyF = true;}
      while(RKqzUaaYxn == YiYrFtIFIa){psYFlwhxWA = true;}
      while(iPdsqxRVmp == iPdsqxRVmp){SNRlqnBJkg = true;}
      while(WIYWceQFdM == WIYWceQFdM){QqpVeKJDBa = true;}
      if(RkgmxmVrXz == true){RkgmxmVrXz = false;}
      if(DmuuVRThDh == true){DmuuVRThDh = false;}
      if(OceVHIkTWp == true){OceVHIkTWp = false;}
      if(JVujVyhpuE == true){JVujVyhpuE = false;}
      if(aZxnmiNdBK == true){aZxnmiNdBK = false;}
      if(KiCuyoFLeo == true){KiCuyoFLeo = false;}
      if(BBUhogrLYX == true){BBUhogrLYX = false;}
      if(iclyGneqiX == true){iclyGneqiX = false;}
      if(uHSLeZTzlf == true){uHSLeZTzlf = false;}
      if(rWLGDYFPyF == true){rWLGDYFPyF = false;}
      if(qBEdahxDoJ == true){qBEdahxDoJ = false;}
      if(KOcHssiJCO == true){KOcHssiJCO = false;}
      if(NrYreMQeug == true){NrYreMQeug = false;}
      if(iOrcfsDojw == true){iOrcfsDojw = false;}
      if(cQKbVdsDMJ == true){cQKbVdsDMJ = false;}
      if(puNirybLyO == true){puNirybLyO = false;}
      if(QRHHZuVzaA == true){QRHHZuVzaA = false;}
      if(psYFlwhxWA == true){psYFlwhxWA = false;}
      if(SNRlqnBJkg == true){SNRlqnBJkg = false;}
      if(QqpVeKJDBa == true){QqpVeKJDBa = false;}
    } 
}; 
...
{ 
  void JCgRbEZZqs()
  { 
      bool SpZeugjmae = false;
      bool YjROIOUaRZ = false;
      bool IomIwxWiTd = false;
      bool ozSkrewroV = false;
      bool aijRFTDbHD = false;
      bool QOsoWdDQiy = false;
      bool KBTxpZRfVd = false;
      bool SbluzYEVCc = false;
      bool staQMZFcNO = false;
      bool beJqLZPmaf = false;
      bool BWGcjncypy = false;
      bool ZhNGEPZDjP = false;
      bool ToRHCmStjY = false;
      bool IQtWaVnyfY = false;
      bool xHlPosRClu = false;
      bool zMDLLMFyax = false;
      bool UhNQoImqei = false;
      bool bbXLRMCCRI = false;
      bool VPHnZuNiKO = false;
      bool QoWhDPsVZf = false;
      string XnTmzjjgCx;
      string CZTnTWCHPy;
      string blueyBshNp;
      string bJmxXPHDBc;
      ...
      string VVXkDLWLxe;
      string EVpQSloKPf;
      if(XnTmzjjgCx == YDMGaTuKRi){SpZeugjmae = true;}
      else if(YDMGaTuKRi == XnTmzjjgCx){BWGcjncypy = true;}
      if(CZTnTWCHPy == aDqBWYeuot){YjROIOUaRZ = true;}
      else if(aDqBWYeuot == CZTnTWCHPy){ZhNGEPZDjP = true;}
      if(blueyBshNp == fokcfwiDzx){IomIwxWiTd = true;}
      else if(fokcfwiDzx == blueyBshNp){ToRHCmStjY = true;}
      if(bJmxXPHDBc == wwCGNWFRuD){ozSkrewroV = true;}
      else if(wwCGNWFRuD == bJmxXPHDBc){IQtWaVnyfY = true;}
      if(byaGhLZbJq == eBeCLTaNeO){aijRFTDbHD = true;}
      else if(eBeCLTaNeO == byaGhLZbJq){xHlPosRClu = true;}
      if(SBxoLlrnny == tjYqJiSiae){QOsoWdDQiy = true;}
      else if(tjYqJiSiae == SBxoLlrnny){zMDLLMFyax = true;}
      if(pCSMUrmVPD == krLUleAjnA){KBTxpZRfVd = true;}
      else if(krLUleAjnA == pCSMUrmVPD){UhNQoImqei = true;}
      if(PyFlWcKnxm == SNzlPdJhRL){SbluzYEVCc = true;}
      if(aRXWXZMxkl == VVXkDLWLxe){staQMZFcNO = true;}
      if(XSOCmYfOlp == EVpQSloKPf){beJqLZPmaf = true;}
      while(SNzlPdJhRL == PyFlWcKnxm){bbXLRMCCRI = true;}
      while(VVXkDLWLxe == VVXkDLWLxe){VPHnZuNiKO = true;}
      while(EVpQSloKPf == EVpQSloKPf){QoWhDPsVZf = true;}
      if(SpZeugjmae == true){SpZeugjmae = false;}
      if(YjROIOUaRZ == true){YjROIOUaRZ = false;}
      if(IomIwxWiTd == true){IomIwxWiTd = false;}
      if(ozSkrewroV == true){ozSkrewroV = false;}
      if(aijRFTDbHD == true){aijRFTDbHD = false;}
      if(QOsoWdDQiy == true){QOsoWdDQiy = false;}
      if(KBTxpZRfVd == true){KBTxpZRfVd = false;}
      if(SbluzYEVCc == true){SbluzYEVCc = false;}
      if(staQMZFcNO == true){staQMZFcNO = false;}
      if(beJqLZPmaf == true){beJqLZPmaf = false;}
      if(BWGcjncypy == true){BWGcjncypy = false;}
      if(ZhNGEPZDjP == true){ZhNGEPZDjP = false;}
      if(ToRHCmStjY == true){ToRHCmStjY = false;}
      if(IQtWaVnyfY == true){IQtWaVnyfY = false;}
      if(xHlPosRClu == true){xHlPosRClu = false;}
      if(zMDLLMFyax == true){zMDLLMFyax = false;}
      if(UhNQoImqei == true){UhNQoImqei = false;}
      if(bbXLRMCCRI == true){bbXLRMCCRI = false;}
      if(VPHnZuNiKO == true){VPHnZuNiKO = false;}
      if(QoWhDPsVZf == true){QoWhDPsVZf = false;}
    } 
}; 
...
{ 
  void CBVFwtFkfB()
  { 
      bool CuKIzhfshc = false;
      bool RYjWEMISop = false;
      bool dqhdyzjjRq = false;
      bool rtjcQXcnjx = false;
      bool zwbkXWwSkm = false;
      bool zurmjKNgKA = false;
      bool xuaqkXnHGf = false;
      bool jUhqphOwFa = false;
      bool DQzeqwBxsF = false;
      bool KudjAEUkAA = false;
      bool hnMEDeNAwC = false;
      bool uRaixguwAn = false;
      bool VpOAVnpxql = false;
      bool MduFsOEuaL = false;
      bool iABpKsUumS = false;
      bool IYjLdqZLhP = false;
      bool oPJJoRVVoh = false;
      bool bAVnFUoXpc = false;
      bool SuKXdnsjaB = false;
      bool orMKWTqqBr = false;
      string wCMlxnYMMf;
      string pRBoDgnKyP;
      string HsSPapqZcd;
      string yjZmIhiqiP;
      ...
      string TmwjfepKOo;
      string ufpoAINhcO;
      if(wCMlxnYMMf == YxBMiQERJF){CuKIzhfshc = true;}
      else if(YxBMiQERJF == wCMlxnYMMf){hnMEDeNAwC = true;}
      if(pRBoDgnKyP == WttCamGmRO){RYjWEMISop = true;}
      else if(WttCamGmRO == pRBoDgnKyP){uRaixguwAn = true;}
      if(HsSPapqZcd == WfKZWKQyPn){dqhdyzjjRq = true;}
      else if(WfKZWKQyPn == HsSPapqZcd){VpOAVnpxql = true;}
      if(yjZmIhiqiP == kCrxihHfNz){rtjcQXcnjx = true;}
      else if(kCrxihHfNz == yjZmIhiqiP){MduFsOEuaL = true;}
      if(NcMdLRLghf == OQDxiDqdBe){zwbkXWwSkm = true;}
      else if(OQDxiDqdBe == NcMdLRLghf){iABpKsUumS = true;}
      if(NeAMjDixLG == IFLhislaoX){zurmjKNgKA = true;}
      else if(IFLhislaoX == NeAMjDixLG){IYjLdqZLhP = true;}
      if(xyjhgFrOfU == zFCVUUBwSs){xuaqkXnHGf = true;}
      else if(zFCVUUBwSs == xyjhgFrOfU){oPJJoRVVoh = true;}
      if(xxahCdfoDI == fZZRzFbNqS){jUhqphOwFa = true;}
      if(eJrwQSiMDF == TmwjfepKOo){DQzeqwBxsF = true;}
      if(ylfcSOsdwF == ufpoAINhcO){KudjAEUkAA = true;}
      while(fZZRzFbNqS == xxahCdfoDI){bAVnFUoXpc = true;}
      while(TmwjfepKOo == TmwjfepKOo){SuKXdnsjaB = true;}
      while(ufpoAINhcO == ufpoAINhcO){orMKWTqqBr = true;}
      if(CuKIzhfshc == true){CuKIzhfshc = false;}
      if(RYjWEMISop == true){RYjWEMISop = false;}
      if(dqhdyzjjRq == true){dqhdyzjjRq = false;}
      if(rtjcQXcnjx == true){rtjcQXcnjx = false;}
      if(zwbkXWwSkm == true){zwbkXWwSkm = false;}
      if(zurmjKNgKA == true){zurmjKNgKA = false;}
      if(xuaqkXnHGf == true){xuaqkXnHGf = false;}
      if(jUhqphOwFa == true){jUhqphOwFa = false;}
      if(DQzeqwBxsF == true){DQzeqwBxsF = false;}
      if(KudjAEUkAA == true){KudjAEUkAA = false;}
      if(hnMEDeNAwC == true){hnMEDeNAwC = false;}
      if(uRaixguwAn == true){uRaixguwAn = false;}
      if(VpOAVnpxql == true){VpOAVnpxql = false;}
      if(MduFsOEuaL == true){MduFsOEuaL = false;}
      if(iABpKsUumS == true){iABpKsUumS = false;}
      if(IYjLdqZLhP == true){IYjLdqZLhP = false;}
      if(oPJJoRVVoh == true){oPJJoRVVoh = false;}
      if(bAVnFUoXpc == true){bAVnFUoXpc = false;}
      if(SuKXdnsjaB == true){SuKXdnsjaB = false;}
      if(orMKWTqqBr == true){orMKWTqqBr = false;}
    } 
}; 
...
{ 
  void wEEBwPYoLT()
  { 
      bool uFjTpVkkNE = false;
      bool fgGIosRrTV = false;
      bool hZwYPpcHrl = false;
      bool ZqDJJMbmXf = false;
      bool YmgJNXnMqx = false;
      bool RLRYQVIKEA = false;
      bool scrbdndxyb = false;
      bool ReTmwurmLr = false;
      bool BQQtUOZdrn = false;
      bool EQiXmwuFeY = false;
      bool tqNOflqdcV = false;
      bool cUzMybMxGP = false;
      bool OzEKXAwuAA = false;
      bool zlIlxJDCOh = false;
      bool XuBVLiRWYL = false;
      bool ixzPKtmDpf = false;
      bool pudbWpMNOo = false;
      bool YKiXqTyhzn = false;
      bool iZWnQCmrbD = false;
      bool WzLirbQYzU = false;
      string sURLsjtfgB;
      string OEuZHLtZbU;
      string kxWnlCutbg;
      string pSQiCQDCkN;
      ...
      string RLHOCJXuOt;
      string EuUfqjDltz;
      if(sURLsjtfgB == wDfkpVVwsN){uFjTpVkkNE = true;}
      else if(wDfkpVVwsN == sURLsjtfgB){tqNOflqdcV = true;}
      if(OEuZHLtZbU == ABIXExfagf){fgGIosRrTV = true;}
      else if(ABIXExfagf == OEuZHLtZbU){cUzMybMxGP = true;}
      if(kxWnlCutbg == nlXPWiPwpV){hZwYPpcHrl = true;}
      else if(nlXPWiPwpV == kxWnlCutbg){OzEKXAwuAA = true;}
      if(pSQiCQDCkN == hsfxEjLhmx){ZqDJJMbmXf = true;}
      else if(hsfxEjLhmx == pSQiCQDCkN){zlIlxJDCOh = true;}
      if(zDCaSkODay == JKIZGRQDob){YmgJNXnMqx = true;}
      else if(JKIZGRQDob == zDCaSkODay){XuBVLiRWYL = true;}
      if(NKLOuuxdZq == TXUjiKePNH){RLRYQVIKEA = true;}
      else if(TXUjiKePNH == NKLOuuxdZq){ixzPKtmDpf = true;}
      if(ozEzKunLWp == FZGWeGVLTU){scrbdndxyb = true;}
      else if(FZGWeGVLTU == ozEzKunLWp){pudbWpMNOo = true;}
      if(IroOVguwUB == kxmjVddyJF){ReTmwurmLr = true;}
      if(mrTcSeHBnG == RLHOCJXuOt){BQQtUOZdrn = true;}
      if(SYbsYzzCPX == EuUfqjDltz){EQiXmwuFeY = true;}
      while(kxmjVddyJF == IroOVguwUB){YKiXqTyhzn = true;}
      while(RLHOCJXuOt == RLHOCJXuOt){iZWnQCmrbD = true;}
      while(EuUfqjDltz == EuUfqjDltz){WzLirbQYzU = true;}
      if(uFjTpVkkNE == true){uFjTpVkkNE = false;}
      if(fgGIosRrTV == true){fgGIosRrTV = false;}
      if(hZwYPpcHrl == true){hZwYPpcHrl = false;}
      if(ZqDJJMbmXf == true){ZqDJJMbmXf = false;}
      if(YmgJNXnMqx == true){YmgJNXnMqx = false;}
      if(RLRYQVIKEA == true){RLRYQVIKEA = false;}
      if(scrbdndxyb == true){scrbdndxyb = false;}
      if(ReTmwurmLr == true){ReTmwurmLr = false;}
      if(BQQtUOZdrn == true){BQQtUOZdrn = false;}
      if(EQiXmwuFeY == true){EQiXmwuFeY = false;}
      if(tqNOflqdcV == true){tqNOflqdcV = false;}
      if(cUzMybMxGP == true){cUzMybMxGP = false;}
      if(OzEKXAwuAA == true){OzEKXAwuAA = false;}
      if(zlIlxJDCOh == true){zlIlxJDCOh = false;}
      if(XuBVLiRWYL == true){XuBVLiRWYL = false;}
      if(ixzPKtmDpf == true){ixzPKtmDpf = false;}
      if(pudbWpMNOo == true){pudbWpMNOo = false;}
      if(YKiXqTyhzn == true){YKiXqTyhzn = false;}
      if(iZWnQCmrbD == true){iZWnQCmrbD = false;}
      if(WzLirbQYzU == true){WzLirbQYzU = false;}
    } 
}; 
...
{ 
  void VJumZDYEfT()
  { 
      bool GoZYzbwmRY = false;
      bool nTsOiYDzNV = false;
      bool CkwUefzVMS = false;
      bool blcOBrCCwc = false;
      bool TXjgrJBLob = false;
      bool IiwzGVrFtS = false;
      bool baazwCpeMq = false;
      bool WBCkBeAOcU = false;
      bool engjJsocIf = false;
      bool AxIdAsxkkp = false;
      bool SVyyEGgLya = false;
      bool VdcYnntpoD = false;
      bool NNWgpZsYjI = false;
      bool gOdlBIoieC = false;
      bool McdgJWUioM = false;
      bool zHwhcFzRHe = false;
      bool NIbotGzpXf = false;
      bool yKKlqjioWT = false;
      bool EKiXJZSuJw = false;
      bool JXaAoDAnmD = false;
      string VicyQkdBoJ;
      string cdjmNFgxGB;
      string bThUHwZhjN;
      string JtEdwftjFX;
      ...
      string hcawEQKBGf;
      string ctZYBLhKUI;
      if(VicyQkdBoJ == IWLaqGmQXs){GoZYzbwmRY = true;}
      else if(IWLaqGmQXs == VicyQkdBoJ){SVyyEGgLya = true;}
      if(cdjmNFgxGB == YksRDmXjQV){nTsOiYDzNV = true;}
      else if(YksRDmXjQV == cdjmNFgxGB){VdcYnntpoD = true;}
      if(bThUHwZhjN == nYFtDZEIVG){CkwUefzVMS = true;}
      else if(nYFtDZEIVG == bThUHwZhjN){NNWgpZsYjI = true;}
      if(JtEdwftjFX == HKypQuLxpD){blcOBrCCwc = true;}
      else if(HKypQuLxpD == JtEdwftjFX){gOdlBIoieC = true;}
      if(VrrRGhdCIC == qcbHWtragZ){TXjgrJBLob = true;}
      else if(qcbHWtragZ == VrrRGhdCIC){McdgJWUioM = true;}
      if(DeADcBAIpU == BqAwjjRQXR){IiwzGVrFtS = true;}
      else if(BqAwjjRQXR == DeADcBAIpU){zHwhcFzRHe = true;}
      if(KwRaAiZGph == CeuRlNmDBH){baazwCpeMq = true;}
      else if(CeuRlNmDBH == KwRaAiZGph){NIbotGzpXf = true;}
      if(LxrieibPOY == aZtNeKwyXI){WBCkBeAOcU = true;}
      if(RXYgJdtABu == hcawEQKBGf){engjJsocIf = true;}
      if(eksjMYaQRX == ctZYBLhKUI){AxIdAsxkkp = true;}
      while(aZtNeKwyXI == LxrieibPOY){yKKlqjioWT = true;}
      while(hcawEQKBGf == hcawEQKBGf){EKiXJZSuJw = true;}
      while(ctZYBLhKUI == ctZYBLhKUI){JXaAoDAnmD = true;}
      if(GoZYzbwmRY == true){GoZYzbwmRY = false;}
      if(nTsOiYDzNV == true){nTsOiYDzNV = false;}
      if(CkwUefzVMS == true){CkwUefzVMS = false;}
      if(blcOBrCCwc == true){blcOBrCCwc = false;}
      if(TXjgrJBLob == true){TXjgrJBLob = false;}
      if(IiwzGVrFtS == true){IiwzGVrFtS = false;}
      if(baazwCpeMq == true){baazwCpeMq = false;}
      if(WBCkBeAOcU == true){WBCkBeAOcU = false;}
      if(engjJsocIf == true){engjJsocIf = false;}
      if(AxIdAsxkkp == true){AxIdAsxkkp = false;}
      if(SVyyEGgLya == true){SVyyEGgLya = false;}
      if(VdcYnntpoD == true){VdcYnntpoD = false;}
      if(NNWgpZsYjI == true){NNWgpZsYjI = false;}
      if(gOdlBIoieC == true){gOdlBIoieC = false;}
      if(McdgJWUioM == true){McdgJWUioM = false;}
      if(zHwhcFzRHe == true){zHwhcFzRHe = false;}
      if(NIbotGzpXf == true){NIbotGzpXf = false;}
      if(yKKlqjioWT == true){yKKlqjioWT = false;}
      if(EKiXJZSuJw == true){EKiXJZSuJw = false;}
      if(JXaAoDAnmD == true){JXaAoDAnmD = false;}
    } 
}; 
...
{ 
  void oqKJexPPQp()
  { 
      bool xzBCFxlhMK = false;
      bool BixFDMztwZ = false;
      bool iBbGBwHljF = false;
      bool sLCEegPyxC = false;
      bool UAaUVFFKKY = false;
      bool NFKuVwXuBI = false;
      bool pAyHRograV = false;
      bool xAwtEhZHju = false;
      bool qwbLqmAGih = false;
      bool JUxnLTCTDf = false;
      bool YNjnaMIQpm = false;
      bool WPKFRtYmPd = false;
      bool oZIrMcDHik = false;
      bool fFEEVdLmjd = false;
      bool ejQwKsKqWQ = false;
      bool uODYqyErby = false;
      bool JAhFHQLFin = false;
      bool ilDlzEJMgS = false;
      bool SMkRoQBeMX = false;
      bool ZTKlTdCKot = false;
      string iJqPXySGjM;
      string dsfalIsVoW;
      string kxZVOIsBjI;
      string ahBfPcUzuS;
      ...
      string gQADAGimeW;
      string oCQNlNAHUE;
      if(iJqPXySGjM == pfmxYYsGRZ){xzBCFxlhMK = true;}
      else if(pfmxYYsGRZ == iJqPXySGjM){YNjnaMIQpm = true;}
      if(dsfalIsVoW == GGqTmIVylf){BixFDMztwZ = true;}
      else if(GGqTmIVylf == dsfalIsVoW){WPKFRtYmPd = true;}
      if(kxZVOIsBjI == qVYfOousIV){iBbGBwHljF = true;}
      else if(qVYfOousIV == kxZVOIsBjI){oZIrMcDHik = true;}
      if(ahBfPcUzuS == snRipwIyyP){sLCEegPyxC = true;}
      else if(snRipwIyyP == ahBfPcUzuS){fFEEVdLmjd = true;}
      if(JGSxqhfxFN == MyDBWlHesF){UAaUVFFKKY = true;}
      else if(MyDBWlHesF == JGSxqhfxFN){ejQwKsKqWQ = true;}
      if(TTdeEljVAP == VlEeDTGGhj){NFKuVwXuBI = true;}
      else if(VlEeDTGGhj == TTdeEljVAP){uODYqyErby = true;}
      if(ERValwrAKI == dzxwfSnHcp){pAyHRograV = true;}
      else if(dzxwfSnHcp == ERValwrAKI){JAhFHQLFin = true;}
      if(ntZWNdecdg == zXAVSsSWJc){xAwtEhZHju = true;}
      if(bwuWoGEVad == gQADAGimeW){qwbLqmAGih = true;}
      if(szyfNqkqKu == oCQNlNAHUE){JUxnLTCTDf = true;}
      while(zXAVSsSWJc == ntZWNdecdg){ilDlzEJMgS = true;}
      while(gQADAGimeW == gQADAGimeW){SMkRoQBeMX = true;}
      while(oCQNlNAHUE == oCQNlNAHUE){ZTKlTdCKot = true;}
      if(xzBCFxlhMK == true){xzBCFxlhMK = false;}
      if(BixFDMztwZ == true){BixFDMztwZ = false;}
      if(iBbGBwHljF == true){iBbGBwHljF = false;}
      if(sLCEegPyxC == true){sLCEegPyxC = false;}
      if(UAaUVFFKKY == true){UAaUVFFKKY = false;}
      if(NFKuVwXuBI == true){NFKuVwXuBI = false;}
      if(pAyHRograV == true){pAyHRograV = false;}
      if(xAwtEhZHju == true){xAwtEhZHju = false;}
      if(qwbLqmAGih == true){qwbLqmAGih = false;}
      if(JUxnLTCTDf == true){JUxnLTCTDf = false;}
      if(YNjnaMIQpm == true){YNjnaMIQpm = false;}
      if(WPKFRtYmPd == true){WPKFRtYmPd = false;}
      if(oZIrMcDHik == true){oZIrMcDHik = false;}
      if(fFEEVdLmjd == true){fFEEVdLmjd = false;}
      if(ejQwKsKqWQ == true){ejQwKsKqWQ = false;}
      if(uODYqyErby == true){uODYqyErby = false;}
      if(JAhFHQLFin == true){JAhFHQLFin = false;}
      if(ilDlzEJMgS == true){ilDlzEJMgS = false;}
      if(SMkRoQBeMX == true){SMkRoQBeMX = false;}
      if(ZTKlTdCKot == true){ZTKlTdCKot = false;}
    } 
}; 
...
{ 
  void qwSpSYgEiX()
  { 
      bool SeoDdcHBUj = false;
      bool XfAdlKWcXG = false;
      bool YriUSYyhWm = false;
      bool NtKlFWtXmn = false;
      bool yJORzuhxhn = false;
      bool SQKHRauUjF = false;
      bool dYdgVdUOYO = false;
      bool QzojIOcRVW = false;
      bool pBAiUxiCTe = false;
      bool bZnhJZfguU = false;
      bool ZTXSXTaZzC = false;
      bool xcyMOcYtMY = false;
      bool tStsmpKGai = false;
      bool huWAwWcgLA = false;
      bool VJCQgyaaTf = false;
      bool AlTWaHZefg = false;
      bool ITzQUBGyPr = false;
      bool AqiMCkPcMo = false;
      bool OjmthwazZo = false;
      bool wyBdrBKlwf = false;
      string UNJwFZxKDP;
      string VsTdtQClQh;
      string lfAzGrRtig;
      string jnMRhUEmmK;
      ...
      string CjaRQFKjBW;
      string bhaUzpshOp;
      if(UNJwFZxKDP == BEeUGLXxHb){SeoDdcHBUj = true;}
      else if(BEeUGLXxHb == UNJwFZxKDP){ZTXSXTaZzC = true;}
      if(VsTdtQClQh == SLdPbRDMPS){XfAdlKWcXG = true;}
      else if(SLdPbRDMPS == VsTdtQClQh){xcyMOcYtMY = true;}
      if(lfAzGrRtig == uAzCSRRYCS){YriUSYyhWm = true;}
      else if(uAzCSRRYCS == lfAzGrRtig){tStsmpKGai = true;}
      if(jnMRhUEmmK == PhisXgKdIs){NtKlFWtXmn = true;}
      else if(PhisXgKdIs == jnMRhUEmmK){huWAwWcgLA = true;}
      if(IzJyTgGbuS == onXZatPgyk){yJORzuhxhn = true;}
      else if(onXZatPgyk == IzJyTgGbuS){VJCQgyaaTf = true;}
      if(aWDgOoNKoN == CKXzqAFbCn){SQKHRauUjF = true;}
      else if(CKXzqAFbCn == aWDgOoNKoN){AlTWaHZefg = true;}
      if(HCbVfgfCwZ == tytoLjbkru){dYdgVdUOYO = true;}
      else if(tytoLjbkru == HCbVfgfCwZ){ITzQUBGyPr = true;}
      if(MOzFYmVBfY == HZDVdHcYbX){QzojIOcRVW = true;}
      if(kpzPFMkfCs == CjaRQFKjBW){pBAiUxiCTe = true;}
      if(GtxZDGWmSm == bhaUzpshOp){bZnhJZfguU = true;}
      while(HZDVdHcYbX == MOzFYmVBfY){AqiMCkPcMo = true;}
      while(CjaRQFKjBW == CjaRQFKjBW){OjmthwazZo = true;}
      while(bhaUzpshOp == bhaUzpshOp){wyBdrBKlwf = true;}
      if(SeoDdcHBUj == true){SeoDdcHBUj = false;}
      if(XfAdlKWcXG == true){XfAdlKWcXG = false;}
      if(YriUSYyhWm == true){YriUSYyhWm = false;}
      if(NtKlFWtXmn == true){NtKlFWtXmn = false;}
      if(yJORzuhxhn == true){yJORzuhxhn = false;}
      if(SQKHRauUjF == true){SQKHRauUjF = false;}
      if(dYdgVdUOYO == true){dYdgVdUOYO = false;}
      if(QzojIOcRVW == true){QzojIOcRVW = false;}
      if(pBAiUxiCTe == true){pBAiUxiCTe = false;}
      if(bZnhJZfguU == true){bZnhJZfguU = false;}
      if(ZTXSXTaZzC == true){ZTXSXTaZzC = false;}
      if(xcyMOcYtMY == true){xcyMOcYtMY = false;}
      if(tStsmpKGai == true){tStsmpKGai = false;}
      if(huWAwWcgLA == true){huWAwWcgLA = false;}
      if(VJCQgyaaTf == true){VJCQgyaaTf = false;}
      if(AlTWaHZefg == true){AlTWaHZefg = false;}
      if(ITzQUBGyPr == true){ITzQUBGyPr = false;}
      if(AqiMCkPcMo == true){AqiMCkPcMo = false;}
      if(OjmthwazZo == true){OjmthwazZo = false;}
      if(wyBdrBKlwf == true){wyBdrBKlwf = false;}
    } 
}; 
...
{ 
  void XzQdlhULoR()
  { 
      bool imZACGSihM = false;
      bool QGdcnuwdOV = false;
      bool beSGrQGpwi = false;
      bool qghZxpjDJb = false;
      bool LOUcwLmapg = false;
      bool BTLtpEUTIl = false;
      bool zclyUiXEfy = false;
      bool LsUmJMJoJf = false;
      bool dfAPhWVnjr = false;
      bool VQuXbicVHN = false;
      bool mitrVIzYjd = false;
      bool ueJbHTcWQx = false;
      bool NjUmbuxxKa = false;
      bool imgwrtkHsY = false;
      bool XwDGxqGTPI = false;
      bool FGFJzDNHPa = false;
      bool LCNJtHxMiM = false;
      bool hUcrZQfOpk = false;
      bool ndgCUchXwn = false;
      bool gdrSNUhtLp = false;
      string nedseZtNyi;
      string TRfiHssZde;
      string rkKFyHIyEz;
      string mQOganVrQY;
      ...
      string dJDLieyDpM;
      string SRDecyxaPR;
      if(nedseZtNyi == ESGIrIPlyU){imZACGSihM = true;}
      else if(ESGIrIPlyU == nedseZtNyi){mitrVIzYjd = true;}
      if(TRfiHssZde == fCBEhWYSHg){QGdcnuwdOV = true;}
      else if(fCBEhWYSHg == TRfiHssZde){ueJbHTcWQx = true;}
      if(rkKFyHIyEz == cfNiyZDOwB){beSGrQGpwi = true;}
      else if(cfNiyZDOwB == rkKFyHIyEz){NjUmbuxxKa = true;}
      if(mQOganVrQY == TGTrkWnNxh){qghZxpjDJb = true;}
      else if(TGTrkWnNxh == mQOganVrQY){imgwrtkHsY = true;}
      if(mQOshIRNbO == zmXPqRwsKk){LOUcwLmapg = true;}
      else if(zmXPqRwsKk == mQOshIRNbO){XwDGxqGTPI = true;}
      if(JYqqwDTYtX == RoIQCXEWJS){BTLtpEUTIl = true;}
      else if(RoIQCXEWJS == JYqqwDTYtX){FGFJzDNHPa = true;}
      if(RuIywCDyHS == FAoxAZhISK){zclyUiXEfy = true;}
      else if(FAoxAZhISK == RuIywCDyHS){LCNJtHxMiM = true;}
      if(WBIErbWRXp == hKVZhoHxrg){LsUmJMJoJf = true;}
      if(ptWopOZWkX == dJDLieyDpM){dfAPhWVnjr = true;}
      if(TxxsHqHPxe == SRDecyxaPR){VQuXbicVHN = true;}
      while(hKVZhoHxrg == WBIErbWRXp){hUcrZQfOpk = true;}
      while(dJDLieyDpM == dJDLieyDpM){ndgCUchXwn = true;}
      while(SRDecyxaPR == SRDecyxaPR){gdrSNUhtLp = true;}
      if(imZACGSihM == true){imZACGSihM = false;}
      if(QGdcnuwdOV == true){QGdcnuwdOV = false;}
      if(beSGrQGpwi == true){beSGrQGpwi = false;}
      if(qghZxpjDJb == true){qghZxpjDJb = false;}
      if(LOUcwLmapg == true){LOUcwLmapg = false;}
      if(BTLtpEUTIl == true){BTLtpEUTIl = false;}
      if(zclyUiXEfy == true){zclyUiXEfy = false;}
      if(LsUmJMJoJf == true){LsUmJMJoJf = false;}
      if(dfAPhWVnjr == true){dfAPhWVnjr = false;}
      if(VQuXbicVHN == true){VQuXbicVHN = false;}
      if(mitrVIzYjd == true){mitrVIzYjd = false;}
      if(ueJbHTcWQx == true){ueJbHTcWQx = false;}
      if(NjUmbuxxKa == true){NjUmbuxxKa = false;}
      if(imgwrtkHsY == true){imgwrtkHsY = false;}
      if(XwDGxqGTPI == true){XwDGxqGTPI = false;}
      if(FGFJzDNHPa == true){FGFJzDNHPa = false;}
      if(LCNJtHxMiM == true){LCNJtHxMiM = false;}
      if(hUcrZQfOpk == true){hUcrZQfOpk = false;}
      if(ndgCUchXwn == true){ndgCUchXwn = false;}
      if(gdrSNUhtLp == true){gdrSNUhtLp = false;}
    } 
}; 
